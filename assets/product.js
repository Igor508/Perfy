...
/***/ "./build/scripts/product/gallery.js":
/*!******************************************!*\
  !*** ./build/scripts/product/gallery.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"](".product .glide").mount();

/***/ }),

/***/ "./build/scripts/product/popover.js":
/*!******************************************!*\
  !*** ./build/scripts/product/popover.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('button[role="popover-box"]').on("keypress", function (e) {
  var $this = cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(this);
...
function openPopover(el) {
  ...
  closePopover(cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(".popover"));
  var $this = el;
...
cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(".popover-toggle").on("click", function () {
  var el = cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(this);
...
cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(".popover-close").on("click", function () {
  var el = cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(this).closest(".popover");
  closePopover(el);
});

/***/ }),

/***/ "./build/scripts/product/product-form.js":
/*!***********************************************!*\
  !*** ./build/scripts/product/product-form.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/util */ "./build/scripts/lib/util.js");
...
if (!customElements.get("product-form")) {
  customElements.define("product-form", /*#__PURE__*/function (_HTMLElement) {
    ...
    function ProductForm() {
      ...
      _this.form = _this.closest("form");
      _this.form.querySelector("[name=id]").disabled = false; // NOTE: THIS IS NOT COMPLETE.

      /*
      Intention is to use JS to wipe the cart *except* for the trial pack, and proceed straight to checkout
      using the functionality in `onSubmitDirectPurchaseHandler`. A customizer checkbox controls direct to checkout
      functionality for the given template. *This should only be used on the trial pack once completed and thoroughly tested.*
      */
      // let formDestination = document.querySelector("[name=return_to]");
      // if (formDestination && formDestination.value == "/checkout/") {
      //   this.form.addEventListener(
      //     "submit",
      //     this.onSubmitDirectPurchaseHandler.bind(this)
      //   );
      //   return;
      // }
      ...
      window.PubSub.subscribe(_lib_events__WEBPACK_IMPORTED_MODULE_3__.PRODUCT_ADD_TO_CART_SUCCESS, _this.resetFormSubmit.bind(_assertThisInitialized(_this)));
      window.PubSub.subscribe(_lib_events__WEBPACK_IMPORTED_MODULE_3__.PRODUCT_QUANTITY_UPDATED, _this.quantityUpdatedListener.bind(_assertThisInitialized(_this)));
      return _this;
    }

    _createClass(ProductForm, [{
      key: "quantityUpdatedListener",
      value: function quantityUpdatedListener(name, _ref) {
        var data = _ref.data;
        var item = data.item;

        if (item.product_type && item.product_type.toLowerCase() === "trial pack") {
          if (this.form.dataset.productType !== "Trial Pack") {
            return;
          }
          ...
          submitButton.querySelector("[data-submit-text]").innerText = submitButton.dataset.atcEnabledLabel;
          return;
        }
      }
    }, {
      key: "resetFormSubmit",
      value: function resetFormSubmit(name, _ref2) {
        var data = _ref2.data;
        var submitButton = this.querySelector('[type="submit"]');
        ...
        if (data.product_type && data.product_type.toLowerCase() === "trial pack") {
          this.showTrialPackStateButton.call(this);
        }
      }
    }, {
      key: "showTrialPackStateButton",
      value: function showTrialPackStateButton() {
        var submitButton = this.querySelector('[type="submit"]');
        submitButton.disabled = true;
        submitButton.setAttribute("aria-disabled", "true");
        submitButton.querySelector("[data-submit-text]").innerText = submitButton.dataset.trialPackLabel;
      } // onSubmitDirectPurchaseHandler(evt) {
      //   evt.preventDefault();
      ...
      //     "hidden"
      //   );
      //   window.PubSub.publish(PRODUCT_ADDED_TO_CART, {
      //     response: { product_type: "Trial Pack" },
      //   });
      //   window.PubSub.subscribe(REMOVE_NON_TRIAL_PACK_ITEMS.SUCCESS, () => {
      //     this.form.submit();
      //   });
      // }
      ...
      value: function onSubmitHandler(evt) {
        ...
        this.handleErrorMessage(); // this.cartNotification.setActiveElement(document.activeElement);

        submitButton.setAttribute("aria-disabled", true);
        submitButton.classList.add("loading");
        this.querySelector(".loading-overlay__spinner").classList.remove("hidden");
        var config = (0,_lib_util__WEBPACK_IMPORTED_MODULE_0__.fetchConfig)("javascript");
        ...
        if (data["properties[Type]"] && data["properties[Type]"].toLowerCase() === "trial pack") {
          delayOpen = true;
        }

        if (window.Cart.hasTrialPack) {
          delayOpen = true;
        }

        window.PubSub.publish(_lib_events__WEBPACK_IMPORTED_MODULE_3__.PRODUCT_FORM_SUBMIT, {
          data: data,
          delayOpen: delayOpen
        });
      }
...
var selectors = {
  sellingPlans: "[data-product-selling-plans]"
};
var sellingPlansScript = document.querySelector(selectors.sellingPlans);
var sellingPlans = {};

if (sellingPlansScript) {
  var data = JSON.parse(sellingPlansScript.innerHTML);
  var plans = (0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(data, function (p) {
    return p.selling_plans;
  });
  plans = (0,lodash_es__WEBPACK_IMPORTED_MODULE_5__["default"])(plans).forEach(function (p) {
    sellingPlans[p.id] = p;
  });
}

var setPricePerCanInRadio = function setPricePerCanInRadio(element) {
  var price = element.querySelector(".rc-option__price");
  var p = price.innerText.replace(/\D/g, "");
  p = Number(p) / (window.pricePerCan || 12);
  p = (0,_shopify_theme_currency__WEBPACK_IMPORTED_MODULE_2__.formatMoney)(p);
  price.setAttribute("data-price-per-can", "(".concat(p, "/can)"));
};

window.PubSub.subscribe(_lib_events__WEBPACK_IMPORTED_MODULE_3__.RECHARGE_INIT, function (name, _ref3) {
  var widget = _ref3.widget;
  // this.rcContainer = widget.container
  var inputSelector = ".rc-radio__input";
  var checkedInputSelector = ".rc-radio__input:checked";
  var inputs;
  var checked;
  var parent;
  var maxLoopCheck = 400;
  var currentLoop = 0;
  var rechargeInterval = setInterval(function () {
    inputs = cash_dom__WEBPACK_IMPORTED_MODULE_1___default()(inputSelector);

    if (inputs.length > 0 && currentLoop < maxLoopCheck) {
      clearInterval(rechargeInterval);
      parent = cash_dom__WEBPACK_IMPORTED_MODULE_1___default()(".rc-container-wrapper");
      checked = cash_dom__WEBPACK_IMPORTED_MODULE_1___default()(checkedInputSelector);
      inputs.on("change", handleChangeEvent);
      setParentClass(checked);
      setTimeout(function () {
        cash_dom__WEBPACK_IMPORTED_MODULE_1___default()(".rc-radio__label").each(function (index, element) {
          setPricePerCanInRadio(element);
        });
      }, 5);
    } // Make sure this doesn't loop forever. This probably isn't a very intensive thing to do, but if recharge doesn't load after
    // 20 seconds (50ms * 400 loops = 20000ms, or 20s) then it probably will never load.


    if (currentLoop >= maxLoopCheck) {
      clearInterval(rechargeInterval);
    }

    currentLoop++;
  }, 50);
  var frequencyCurrentLoop = 0;
  var frequencyInterval = setInterval(function () {
    var options = document.querySelectorAll("[data-plans-dropdown] option");

    if (options.length > 0 && frequencyCurrentLoop < maxLoopCheck) {
      clearInterval(frequencyInterval);
      document.querySelectorAll("[data-plans-dropdown] option").forEach(function (o) {
        if (o.dataset.planOption.trim().toLowerCase() == "4 weeks") {
          o.selected = true;
        }
      });
    } // Make sure this doesn't loop forever. This probably isn't a very intensive thing to do, but if recharge doesn't load after
    ...
    if (frequencyCurrentLoop >= maxLoopCheck) {
      clearInterval(frequencyInterval);
    }

    frequencyCurrentLoop++;
  }, 50);

  function setParentClass(item) {
    parent.removeClass("selling-plan--onetime selling-plan--subsave");
    parent.addClass("selling-plan--".concat(item.val()));
  }

  function handleChangeEvent(e) {
    var checked = cash_dom__WEBPACK_IMPORTED_MODULE_1___default()(checkedInputSelector);
    setParentClass(checked);
  }
});
...
/***/ "./build/scripts/product/recharge.js":
/*!*******************************************!*\
  !*** ./build/scripts/product/recharge.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/events */ "./build/scripts/lib/events.js");
...
function init() {
  var product = document.querySelector("[data-productid]");

  if (!product) {
    return;
  }

  var productId_attribute = product.getAttribute("data-productid");
  var widget = window.ReChargeWidget.createWidget({
    productId: Number(productId_attribute),
    injectionParent: "[data-productid=\"".concat(productId_attribute, "\"]")
  });
  window.PubSub.publish(_lib_events__WEBPACK_IMPORTED_MODULE_0__.RECHARGE_INIT, {
    widget: widget
  });
}
...
/***/ "./build/scripts/product/related-products-navigation.js":
/*!**************************************************************!*\
  !*** ./build/scripts/product/related-products-navigation.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var selectors = {
  dropdown: "[data-linked-products]"
};
cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(selectors.dropdown).on("change", function () {
  ...
  var url = selected.dataset.relatedProductUrl;
...
"use strict";
/*!**********************************!*\
  !*** ./build/scripts/product.js ***!
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _product_related_products_navigation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./product/related-products-navigation */ "./build/scripts/product/related-products-navigation.js");
/* harmony import */ var _product_gallery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./product/gallery */ "./build/scripts/product/gallery.js");
/* harmony import */ var _product_product_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./product/product-form */ "./build/scripts/product/product-form.js");
/* harmony import */ var _product_recharge__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./product/recharge */ "./build/scripts/product/recharge.js");
/* harmony import */ var _product_popover__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./product/popover */ "./build/scripts/product/popover.js");
